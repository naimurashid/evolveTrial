...
This outlines how to propose a change to evolveTrial. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("naimurashid/evolveTrial", fork = TRUE)`.
...
Please note that the evolveTrial project is released with a [Contributor
